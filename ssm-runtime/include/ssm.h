...
/** @brief Create a nil-pointer.
 * 
 * @return a #ssm_value_t that points to NULL.
 */
#define nil_pointer()                                                          \
  (ssm_value_t) { .packed_val = 0x00000000 }

/** @brief Test if a #ssm_value_t is a nil-pointer.
 * 
 * @return non-zero if nil-pointer, zero otherwise.
 */
#define is_nil(v) ((v).packed_val == 0x00000000)
